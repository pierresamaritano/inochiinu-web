  ...
  const dogs: DogProfile[] = [
    {
      ...
      images: [{ src: "/FULL-Akita.jpeg", alt: "Baiko", tag: "Morphologie", caption: "Construction puissante et ossature forte." },{ src: "/VID-Akita.mp4",type: "video",alt: "Baiko en mouvement", tag: "En Action",caption: "Mouvement fluide et puissant caractéristique de la race." },{ src: "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?q=80&w=2000&auto=format&fit=crop", alt: "Baiko", tag: "Standard", caption: "Respect rigoureux du standard japonais." }],
