  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 flex flex-col items-center pt-4 transition-all duration-300">
      ...
      >
        ...
        {/* Menu Central avec Bulle Liquid Glass synchronisée sur le fond */}
        <div 
        ...
        >
          {/* La bulle de survol : Verre optique transparent (sans blanc opaque) qui absorbe les nuances orange du dessous */}
          <div
