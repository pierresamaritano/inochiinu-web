...
export default function LiquidNavbar() {
  ...
  return (
    <>
      <header className="fixed top-0 inset-x-0 z-50 flex flex-col items-center pt-4 transition-all duration-300">
        ...
        >
          ...
          <button
            ...
            className="px-4 py-3 text-sm font-bold text-orange-600 active:bg-orange-100/50 hover:bg-orange-100/50 rounded-2xl transition-all text-center"
          >
            Connexion
          </button>
        </div>
      ...
      {/* Pop-up Modale de Connexion Google */}
